  ...
  template: `
    <v-container fluid class="selectable" id="up">
      ...
      <v-layout class="wrapper-list-reference">
        ...
        <div class="wrapper-list-reference__item">
          <div class="wrapper-list-reference__item-content-wrapper">
            <a @click.stop="$vuetify.goTo('#combined_portfolio')"
              >Составной портфель</a
            >
          </div>
          <div class="wrapper-list-reference__item-content-wrapper">
          ...
          <div class="wrapper-list-reference__item-content-wrapper">
            <a @click.stop="$vuetify.goTo('#settings_portfolio')"
              >Управление портфелями</a
            >
          </div>
        </div>
        <div class="wrapper-list-reference__item">
          <div class="wrapper-list-reference__item-content-wrapper">
            <a @click.stop="$vuetify.goTo('#settings_public')"
              >Публичный доступ</a
            >
          </div>
          <div class="wrapper-list-reference__item-content-wrapper">
          ...
          <div class="wrapper-list-reference__item-content-wrapper">
            <a @click.stop="$vuetify.goTo('#settings_promo_codes')"
              >Промо-коды</a
            >
          </div>
          <div class="wrapper-list-reference__item-content-wrapper">
            <a @click.stop="$vuetify.goTo('#settings_notifications')"
              >Уведомления</a
            >
          </div>
          <div class="wrapper-list-reference__item-content-wrapper">
      ...
      <div>
        <v-expansion-panel expand class="wrapper-panel" v-model="panel">
                ...
                <div class="wrapper-content-panel__paired-section">
                  ...
                  <div class="wrapper-content-panel__paired-section-item">
                    ...
                    <div class="apple-google-pic">
                      <a
                        href="https://itunes.apple.com/ru/app/intelinvest-%D1%83%D1%87%D0%B5%D1%82-%D0%B8%D0%BD%D0%B2%D0%B5%D1%81%D1%82%D0%B8%D1%86%D0%B8%D0%B9
                                                /id1422478197?mt=8"
                        title="Загрузите приложение в App Store"
                        target="_blank"
                      >
                      ...
                      >
                        <img
                          src="./img/help/google-play-badge2.svg"
                          alt="pic"
                        />
                      </a>
                    </div>
                  ...
                  <div class="wrapper-content-panel__paired-section-item">
                    <p>
                      ...
                      <v-btn
                        ...
                        icon
                        color="#3b6ec9"
                        class="wrapper-content-panel__paired-section-item__add-deal-btn"
                      >
                        <v-icon>add</v-icon>
                      </v-btn>
                    </p>
                    ...
                    <p>
                      Для акции это - Купить, Продать, Дивиденд; для облигации -
                      Купить, Продать, Погашение, Купон,
                    </p>
                    <p>
                      Амортизация для денег - Внести, Вывести, Доход, Расход.
                    </p>
                    <p>
          ...
          <v-expansion-panel-content>
            ...
            <template v-slot:header>
              <div id="balances">Текущие остатки</div>
            </template>
            <v-card>
              <div class="wrapper-content-panel">
                ...
                <div class="wrapper-content-panel__paired-section">
                  <div class="wrapper-content-panel__paired-section-item">
                    ...
                    <p>
                      ...
                      годовая доходность портфеля, в также изменение стоимости
                ...
                <div class="wrapper-content-panel__paired-section">
                  <div class="wrapper-content-panel__paired-section-item">
                    <p>
                      ...
                      <a
                        @click.stop="openDialog(assetType.MONEY, operation.INCOME)"
                        ><span>Доход</span></a
                      >
                      /
                      <a
                        @click.stop="openDialog(assetType.MONEY, operation.LOSS)"
                        ><span>Расход</span></a
                      >
                      или
                      <a
                        @click.stop="openDialog(assetType.MONEY, operation.DEPOSIT)"
                        ><span>Внести</span></a
                      >
                      /
                      <a
                        @click.stop="openDialog(assetType.MONEY, operation.WITHDRAW)"
                        ><span>Вывести</span></a
                      >
                ...
                <div class="wrapper-content-panel__paired-section">
                  <div class="wrapper-content-panel__paired-section-item">
                    <p>
                      ...
                      отображаются текущие начисления (дивиденды, купоны,
                      амортизация, погашения) по бумагам в портфеле.
                    </p>
                    <p>
                ...
                <div class="wrapper-content-panel__paired-section">
                  <div class="wrapper-content-panel__paired-section-item">
                    <p>
                      ...
                      представлено четыре таблицы. Суммарные дивиденды.
                      Отображаются суммарные выплаты и доходность по каждой
                      акции.
                    </p>
                    <p>
            ...
            <v-card>
              <div class="wrapper-content-panel">
                <div class="wrapper-content-panel__paired-section">
                  <div class="wrapper-content-panel__paired-section-item">
                    <div>
                      <a id="settings_portfolio" class="non-cursor-click"
                        >Управление портфелями</a
                      >
                    </div>
                    <p>
                    ...
                    <div>
                      <a id="settings_public" class="non-cursor-click"
                        >Публичный доступ</a
                      >
                    </div>
                    <p>
                  ...
                  <div class="wrapper-content-panel__paired-section-item">
                    ...
                    <div>
                      <a id="settings_promo_codes" class="non-cursor-click"
                        >Промо-коды</a
                      >
                    </div>
                    <p>
                      <a href="#/promo-codes">В данном</a>
                      разделе будет представлен личный промо код, которым вы
                      сможете делиться со своими знакомыми. Воспользовавшись им,
                      они получают скидку 20% на первую покупку любого тарифного
                      плана, а вы получаете месяц подписки совершенно бесплатно
                      с первой оплаты либо 30% от всех последующих оплат
                      приглашенного Вами пользователя. Ниже можно настроить вид
                      вознаграждения.
                    </p>
                    <div>
                      <a id="settings_notifications" class="non-cursor-click"
                        >Уведомления</a
                      >
                    </div>
                    <p>
                      <a href="#/notifications">Здесь</a>
                      можно настроить уведомления о достижении целевых цен на
                      акции и подписаться на новости интересующих эмитентов. В
                      первом случае вы формируете список акций для оповещений, и
                ...
                <div class="wrapper-content-panel__single-section">
                  <div class="wrapper-content-panel__single-section-item">
                    <p>
                      ...
                      <a
                        href="https://telegram.me/intelinvestSupportBot"
                        title="Задайте вопрос в Telegram"
                        target="_blank"
                        >telegram</a
                      >
              ...
              <div class="wrapper-content-panel">
                ...
                <div>
                  <v-btn
                    ...
                    right
                    color="#F0F3F8"
                    @click.stop="$vuetify.goTo('#up')"
                    class="wrapper-content-panel__privacy-section-up-page-btn"
                  >
...
export class HelpPage extends UI {
  ...
  private async openFeedBackDialog(): Promise<void> {
    await new FeedbackDialog().show(
      this.$root.$store.state[StoreType.MAIN].clientInfo
    );
  }
}
