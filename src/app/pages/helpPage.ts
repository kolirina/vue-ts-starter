        ...
        <v-container fluid class="selectable">
            ...
            <span>
                <ul>
                    ...
                    <li><a href="#profile" @click.stop="$vuetify.goTo('#profile', { offset: -64 })">Профиль</a></li>
            ...
            <span>
                ...
                <span>
                    ...
                    <p>
                        Сервисом пользоваться как в web-версии, так и с мобильных устройств. Мы поддерживаем как ios, так и android.
                ...
                <span>
                    <p>
                        В боковой панели меню расположена кнопка добавления сделок
                ...
                <span>
                    <p>
                        ...
                        <a href="#/portfolio">портфеля</a> и ценным бумагам, входящим в его состав.
                        В интерактивных информерах сверху представлены наиболее важные показатели: текущая суммарная стоимость,
                ...
                <span>
                    ...
                    Например, чтобы просмотреть сделки только по продаже, необходимо нажать на кнопку "Фильтр"
                    и в блоке "Тип операции сделок" отключить отображение для всех операций, кроме пункта "Продать".
                    Для каждой сделки доступно редактирование параметров, оно зависит от типа сделки (Акция, Облигация, Деньги).
                    Быстро добавить сделку можно по нажатию на кнопку +, расположенную на меню слева.
                    При разворачивании строки таблицы доступна подробная информация о сделке.
                </span>
                ...
                <span>
                    ...
                    <ul>
                        ...
                        <a href="#/notifications">Здесь</a> можно настроить уведомления о достижении целевых цен на акции и облигации
                        и подписаться на новости интересующих эмитентов. В первом случае вы формируете список акций для оповещений,
                        и задаете цены, при которых будет срабатывать уведомление. Для целевой цены можно можно задать допуск цены,
                        чтобы увеличить диапазон срабатывания. При достижении целевой цены будет отправлено письмо с уведомлением.
                        Уведомления отправляются один раз за текущий день, при достижении целевых цен.
                    </ul>
                </span>

                <h1 id="profile">Профиль</h1>
                <span>
                    <a href="#/profile">Здесь</a> можно сменить пароль и адрес электронной почты.
                    Новый адрес необходимо подтвердить. Уведомления будут приходить на новый адрес электронной почты.
                </span>
