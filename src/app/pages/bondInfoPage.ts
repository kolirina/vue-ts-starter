                            ...
                            <div>
                                ...
                                <table class="info-about-stock__content">
                                    ...
                                    <tbody>
                                        ...
                                        <!--<tr>
                                            <td class="info-about-stock__content-title">Компания</td>
                                            <td>
                                                <span class="info-about-stock__content-value">
                                                    {{ share.shortname }}
                                                </span>
                                        ...
                                        <tr>
                                            <td class="info-about-stock__content-title">Регистрационный номер</td>
                                            <td>
                                                <span class="info-about-stock__content-value">
                                                    {{ share.regnumber }}
                                                </span>
                                ...
                                <table class="info-about-stock__content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="info-about-stock__content-value">
                                                    {{ share.nextcoupon }}, {{ share.couponvalue }}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
