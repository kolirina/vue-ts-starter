...
const INTRO_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        content: "Если вам необходимо добавить какую-либо сделку вручную, это можно сделать кликнув на иконку Плюсика. В данном диалоговом окне" +
        "вы сможете внести сделки по купле/продаже акций и облигаций, купону, дивиденду, амортизации, расходу, доходу, внесению, списанию денег, конвертации валют.",
        params: {
            placement: "right"
        }
    },
