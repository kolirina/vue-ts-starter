...
const INTRO_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        content: "Ознакомьтесь с инструкцией по скачиванию отчета вашего брокера в корректном формате и с видео инструкцией по импорту сделок. Далее загрузите отчет брокера использовав кнопку выбора файла или просто перетащите нужный файл в зону загрузки.",
        params: {
            placement: "top"
        }
    },
    {
        ...
        content: "Если после загрузки отчета вы увидели ошибку импорта - вероятнее всего вы загрузили отчет в неверном формате. Перечитайте пожалуйста инструкцию по скачиванию отчета брокера на странице Настройки - Импорт сделок или обратитесь в техподдержку.",
        params: {
            placement: "right"
        }
    },
    {
        ...
        content: "Если после загрузки отчета вы увидели список ошибок - ознакомьтесь пожалуйста с причинами их возникновения в инструкции на странице импорта или обратитесь в техподдержку.",
        params: {
            placement: "right"
        }
    },
    {
        ...
        content: "Если ваши остатки по валютам после импорта отчета не совпадают с реальными, их необходимо скорректировать. Ввести актуальные остатки вы можете на этой форме.",
        params: {
            placement: "left"
        }
    },
