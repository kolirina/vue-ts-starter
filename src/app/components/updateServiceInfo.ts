    ...
    template: `
        <div class="update-service-dialog__content">
            <div>
                ...
                <ul>
                    <li>
                        Улучшили работу с фильтром бумаг на странице Котировки, Сделки.
                    </li>
                    <li>
                        Добавили htm формат для импорта отчетов.
                    </li>
                    <li>Добавили сохранение состояния меню (свернуто/развернуто) после обновления страницы.</li>
                    <li>Создали отдельную страницу для входа в приложение, теперь зарегистрированные пользователи могут попасть на главную страницу сервиса без разлогинивания.</li>
                    <li>Улучшили цвета круговых диаграмм по вашим просьбам.</li>
                    <li>
