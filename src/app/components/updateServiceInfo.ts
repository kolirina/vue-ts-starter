    ...
    template: `
        <div class="update-service-dialog__content selectable">
            <div>
                ...
                <div class="update-service-dialog__date">01.12.2020</div>
                <ul>
                    <li>
                        Главное изменение ноября: <br/>
                        Возможность добавлять кастомные тэги на любые активы в портфеле.<br/>
                        Тэги позволят смотреть аналитику по любой характеристике, которая вам нужна.
                        Настраиваются в Настройки - Управление тэгами,
                        назначаются на странице Порфтель, просмотр графиков в Аналитике.
                    </li>
                    <li>
                        В разделе Аналитика добавлены новые диаграммы:<br/>
                        Распределение активов по странам<br/>
                        Распределение активов по валюте<br/>
                    </li>
                    <li>
                        Обновили результаты импорта и разбили их на 3 категории по важности.
                    </li>
                    <li>
                        Обновлено боковое меню с иконками, теперь работать станет еще комфортнее!
                    </li>
                ...
                <template v-if="loggedIn">
                    <expanded-panel :value="oldUpdatesPanelState" class="promo-codes__statistics">
                        ...
                        <div class="update-service-dialog__date">30.09.2020</div>
                        <ul>
                            <li>
                                Теперь разделы <b>Аналитика</b>, <b>Начисления</b>, <b>События</b> и <b>Сделки</b> можно просматривать и по Составному портфелю!
                                Составной портфель доступен для выбора так же как и обычный в переключателе портфелей.
                                Сформировать портфель можно нажав на иконку в переключателе, или на странице Портфель.
                            </li>
                            <li>
                                Доработали раздел Дивиденды, теперь он называется <b>Начисления</b>, и в нем доступна аналитика по купонам.<br/>
                                В таблице годовых начислений можно посмотреть доходности отдельно по дивидендам и купонам.
                            </li>
                            <li>
                                В разделе События добавлен новый блок <b>Будущие начисления</b>, который позволит вам оценить потоки будущих платежей,
                                которые ваш портфель принесет в ближайший год. <br/>
                                Данные представлены в виде наглядного графика с разбивкой по месяцам.
                            </li>
                            <li>
                                Добавлен раздел <b>Инвестотека</b>, где можно посмотреть каталог
                                публичных портфелей от известных блоггеров, фин. советников, инвест. школ.<br/>
                                Если вы хотите опубликовать свой портфель, вы можете сделать это в разделе<br/>
                                Каждый может найти подходящие для себя стратегии от опытных инвесторов.
                                Просмотреть состав активов, отследить динамику изменений, выявить ключевые активы в текущей ситуации рынка
                            </li>
                            <li>
                                Обновили раздел Партнерской программы
                            </li>
                            <li>Улучшили и исправили импорт
                                <ul>
                                    <li>Тинькофф</li>
                        ...
                        <div class="update-service-dialog__date">29.08.2020</div>
                        <ul>
                            <li>
                                Добавлена <b>аналитика по прибыли</b> портфеля.<br/>
                                Теперь прибыль портфеля можно анализировать в виде графика по дням.<br/>
                                На графике доступна разбивка прибылей по Общей, Курсовой, По сделкам, от Дивидендов и купонов.<br/>
                                Появились столбчатые диаграммы прибыли по месяцам и годам.<br/>
                                По ним можно определить был месяц или год успешным или нет.
                            </li>
                            <li>
                                Добавили поддержку валютных пар. Их можно найти на странице <b>Котировки</b> → <b>Общие</b>
                                фильтр <i>Валюты</i>
                            </li>
                            <li>
                                Добавили поддержку зарубежным бумаг, торгуемых на Московской бирже.
                            </li>
                            <li>
                                Улучшили раздел <b>Управление портфелями</b><br/>
                                Теперь Редактировать или настроить важные параметры портфеля стало проще.<br/>
                                Если хотите поделиться своим портфелем с коллегами или подписчиками,<br/>
                                теперь это сделать проще: на вкладке <b>Публичный доступ</b> настройте необходимые вам параметры и сохраните.<br/>
                            </li>
                            <li>Улучшили и исправили импорт
                                <ul>
                                    <li>Тинькофф</li>
                        ...
                        <div class="update-service-dialog__date">26.06.2020</div>
                        <ul>
                            <li>
                                Улучшили раздел Истории Импорта. Теперь он отображает полные результаты
                                которые были получены при импорте отчетов.
                            </li>
                            <li>
                                Изменили, для лучшего восприятия, диаграмму эффективности бумаг,
                                чтобы можно было оценивать и те бумаги, которые пока в минусе.
                            </li>
                            <li>
                                Улучшили раздел Профиль
                            </li>
                            <li>Улучшили и исправили импорт
                                <ul>
                                    <li>Тинькофф</li>
                        ...
                        <ul>
                            ...
                            <li>Список последних обновлений теперь вы можете посмотреть в Справке</li>
